    ...
    <div class="container-login100">
      <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
        <form class="login100-form validate-form flex-sb flex-w" method="POST" action="{{ route('register') }}">
          ...
          <div class="wrap-input100 validate-input m-b-36 {{ $errors->has('name') ? ' has-error' : '' }}">
          ...
          <div class="wrap-input100 validate-input m-b-12{{ $errors->has('password') ? ' has-error' : '' }}">
...
{{--           <div class="form-group">
        ...
        <P class="mu-2">
            Already Registred?
            <a class="align-middle" href="{{ route('login') }}" 
