...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" style="background:rgb(243, 247, 253) ">
	...
	<form method="POST" action="{{action('ChannelController@update', $channel->id)}}">
		...
		<div class="form-group row">
		    ...
		    <div class="col-sm-9">
		      <input type="text" id="form-field-1" name="name" class="col-xs-10 col-sm-5" value="{{$channel->name}}">
		    </div>
		</div>
		...
		<div class="form-group row">
		    ...
		    <div class="col-sm-9">
		      <input type="text" id="form-field-1" name="slug" class="col-xs-10 col-sm-5" alue="{{$channel->slug}}">
		    </div>
		</div>
