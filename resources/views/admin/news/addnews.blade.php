...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" style="background:rgb(243, 247, 253) ">
	...
	<form method="POST" action="/admin/add-news" enctype="multipart/form-data">
		...
		<div class="form-group row">
		    ...
		    <div class="col-sm-9">
		      <input type="text" id="form-field-1" name="topic" class="col-xs-10 col-sm-5" value="{{old('topic')}}">
		    </div>
		</div>
		...
		<div class="form-group row">
		    ...
		    <div class="col-sm-9">
		      <input type="number" id="form-field-1" name="minimum" class="col-xs-10 col-sm-5" 
		      value="{{old('minimum')}}">
		    </div>
		</div>
		...
		<div class="form-group ">
			...
			<div class="col-sm-5 margin_center">
	    		<input type="file" class="col-xs-10 col-sm-5" name="news_img" id="customFile" onchange="readURL(this);" required>
