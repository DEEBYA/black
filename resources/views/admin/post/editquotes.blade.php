...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4" >
	...
	<form method="POST" action="{{action('QuotesController@update', $quotes->id)}}">
		{{csrf_field()}}
		<div class="form-group row">
		    <label class="col-sm-3 control-label  col-form-label" > Quotes Author: </label>
		    <div class="col-sm-9">
		      <input type="text" id="form-field-1" name="title" class="col-xs-10 col-sm-5" value="{{$quotes->title}}">
		    </div>
		</div>
		...
		<div class="form-group row">
		    ...
		    <div class="col-sm-9">
		      <textarea class="col-xs-10 col-sm-5" id="" name="body" rows="3" type="textarea" value="{{$quotes->body}}"></textarea>
		    </div>
		</div>
